...
def notice():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Tera.Bap.Ka.Id.Hain"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/SUPER ZONE/approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
